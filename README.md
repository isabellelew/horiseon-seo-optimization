For this project I refactored existing code, including fixing a broken link, cleaning up CSS by consolidating selectors and properties, using semantic HTML structure where necessary, and adding in comments. 
